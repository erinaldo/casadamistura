...
namespace PDV
{
    public class Class2
    {
        ...
        public int CadastraFluxo(string pcaixa, string pcpf,bool pimpresso)
        {
            string SQInsert = null;
            int idfluxocaixa = 0;
            SQInsert += "INSERT INTO p_fluxo_caixa ";
            SQInsert += "(CAIXA,CPF,IMPRESSO,DATA_CADASTRO) ";
            SQInsert += " VALUES (?,?,?,?)";
            ...
            cmd.Parameters.Add("@IMPRESSO", OleDbType.Boolean).Value = pimpresso;
