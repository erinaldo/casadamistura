...
namespace PDV
{
    public partial class EditarProduto : Form
    {
        ...
        private void EditarProduto_KeyPress(object sender, KeyPressEventArgs e)
        {
            if(e.KeyChar == (char)13)
            {
                try
                {
                    ...
                    int coluna;
                    string valor;
                    coluna = (dataGridView1.CurrentCell != null ? dataGridView1.CurrentCell.ColumnIndex : 0);
                    linha = (dataGridView1.CurrentCell != null ? dataGridView1.CurrentCell.RowIndex : 0);
                    if (linha > 0)
                    {
        ...
        private void EditarProduto_KeyDown(object sender, KeyEventArgs e)
        {
